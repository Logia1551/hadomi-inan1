    ...
    try {
      ...
      if (identifier.isEmpty || password.isEmpty) {
        throw FirebaseAuthException(
          code: 'invalid-input',
          message:
              'Naran Uzuáriu/Email/Númeru Telefone no senha tenke prenxe iha',
        );
      }
      ...
      if (email == null || email.isEmpty) {
        throw FirebaseAuthException(
          ...
          message: 'Métodu login ne ebé la válidu',
        );
      }
      ...
      switch (e.code) {
        case 'user-not-found':
          errorMessage = 'La hetan konta';
          break;
        case 'wrong-password':
          errorMessage = 'Senha ne ebé laloos';
          break;
        case 'invalid-email':
          errorMessage = 'Formatu email ne ebé la válidu';
          break;
        case 'user-disabled':
          errorMessage = 'Konta dezativa ona';
          break;
        case 'invalid-input':
          errorMessage =
              e.message ?? 'Favor prenxe informasaun login hotu-hotu';
          break;
        default:
          errorMessage = 'Iha erru ida. Favor koko fali';
      }
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Naran Uzuáriu/Email/Númeru Telefone',
                      hintStyle: TextStyle(
