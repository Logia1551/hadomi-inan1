...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (_nameController.text.isEmpty ||
      ...
      _showErrorSnackBar(
          'Presiza kampu hotu-hotu exetu númeru telefone no foto perfil');
      return;
    }
    ...
    if (!RegExp(r'^[a-zA-Z0-9_]+$').hasMatch(_usernameController.text)) {
      _showErrorSnackBar(
          'Naran utilizadór sira bele iha de it letra sira, númeru sira no subliña sira');
      return;
    }
    ...
    if (!RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$')
      ...
      _showErrorSnackBar('Formatu email ne ebé la válidu');
      return;
    }
    ...
    if (_phoneController.text.isNotEmpty &&
      ...
      _showErrorSnackBar('Formatu númeru telefone ne ebé la válidu');
      return;
    }

    // Validate password
    if (_passwordController.text.length < 6) {
      _showErrorSnackBar('Password tenke iha pelumenus karakter 6');
      return;
    }

    if (_passwordController.text != _confirmPasswordController.text) {
      _showErrorSnackBar('Password sira la hanesan');
      return;
    }

    // Validate pregnancy date if pregnant
    if (_isPregnant && _pregnancyDate == null) {
      _showErrorSnackBar('Favor hili data isin-rua nian');
      return;
    }
    ...
    try {
      ...
      if (usernameQuery.docs.isNotEmpty) {
        _showErrorSnackBar('Naran utilizadór uza daudaun ona');
        setState(() {
          _isLoading = false;
        });
        return;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Rejistu susesu ona! Favor ida tama.'),
      ...
      switch (e.code) {
        ...
        case 'operation-not-allowed':
          errorMessage = 'Rejistu liuhosi email dezativadu';
          break;
        case 'weak-password':
          errorMessage = 'Password fraku liu';
          break;
        default:
          errorMessage = 'Erru ida akontese bainhira rejista';
      }
      _showErrorSnackBar(errorMessage);
    } catch (e) {
      _showErrorSnackBar('Iha erru ida. Favor koko fali');
    } finally {
      if (mounted) {
        setState(() {
          _isLoading = false;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    'Kompleta ita-boot nia dadus pesoál',
                    style: TextStyle(
                ...
                _buildTextField(
                  ...
                  hintText: 'Númeru Telefone (Opsionál)',
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  _pregnancyDate == null
                                      ? 'Hili data isin-rua nian'
                                      : 'Data: ${_pregnancyDate!.day}/${_pregnancyDate!.month}/${_pregnancyDate!.year}',
                                  style: TextStyle(
