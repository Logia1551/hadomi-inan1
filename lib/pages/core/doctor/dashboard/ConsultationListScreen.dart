          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  'Laiha pasiente sira ne ebé disponivel',
                  style: TextStyle(
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  'Laiha pasiente ida ne ebé maka\nkoresponde ho peskiza',
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isEnded
                      ? 'Laiha konsulta ida maka kompleta ona'
                      : 'Laiha konsulta aktivu',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.grey[600],
                    fontSize: 16,
