    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: status == 'kompleta ona' ? Colors.green : Colors.red,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Oráriu ${DateFormat('d MMMM yyyy', 'id_ID').format(_selectedDay)}',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'Laiha oráriu konsultasaun\nnian iha data ida-ne e',
