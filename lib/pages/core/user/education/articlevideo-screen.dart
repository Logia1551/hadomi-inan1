...
// Add this flag to track mounted state
  ...
  Future<void> _fetchContent() async {
    ...
    try {
      ...
      // Check mounted state before calling setState or showing SnackBar
      if (!mounted) return;
          ...
          children: [
            ...
            filteredArticles.isEmpty
                ? const Padding(
                    ...
                    child: Text('Laiha artigu sira ne ebé disponivel'),
                  )
        ...
        child: Column(
          children: [
            ...
            filteredVideos.isEmpty
                ? const Padding(
                    padding: EdgeInsets.all(16.0),
                    child: Text('Laiha vídeo sira ne ebé disponivel'),
                  )
          ...
          if (videoUrl != null) {
            try {
              if (await canLaunchUrl(videoUrl)) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Labele loke video')),
                );
              }
            } catch (e) {
              ScaffoldMessenger.of(context).showSnackBar(
