  ...
  Future<void> _fetchOnlineClasses() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('La konsege hatama klase online: $e')),
      );
    }
  }
  ...
  Widget _buildOnlineClassesList() {
    ...
    if (filteredClasses.isEmpty) {
      return const Padding(
        ...
        child: Text('Laiha klase online ne ebé disponivel'),
      );
    }
          ...
          if (classUrl != null) {
            try {
              if (await canLaunchUrl(classUrl)) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Labele loke klase online')),
                );
              }
            } catch (e) {
              ScaffoldMessenger.of(context).showSnackBar(
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('URL klase online nian la válidu')),
            );
          }
        },
