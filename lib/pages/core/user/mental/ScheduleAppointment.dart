    ...
    try {
      ...
      if (currentUser == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Favor tama uluk')),
        );
        return;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Oráriu konsultasaun nian kria ho susesu'),
        ...
        onPressed: () {
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: const Text('Konfirmasaun Ajenda'),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Dotor: ${widget.selectedCounselor['name']}'),
                  const SizedBox(height: 5),
                  Text(
                      'Espesializasaun: ${widget.selectedCounselor['specialization']}'),
                  const SizedBox(height: 5),
                  Text(
                      'Data: ${DateFormat('dd MMMM yyyy').format(selectedDate)}'),
                  const SizedBox(height: 5),
                  Text('Oras: $selectedTime'),
                ],
              ),
              actions: [
                TextButton(
