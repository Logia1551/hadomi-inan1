...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      print('Erru iha karregamentu dadus utilizadór nian: $e');
      setState(() => _isLoading = false);
    }
  }
            ...
            children: [
              ...
              if (_currentProfileImage != null || _newProfileImage != null)
                ListTile(
                  ...
                  title: const Text('Haree Foto sira'),
                  onTap: () {
              ...
              ListTile(
                ...
                title: const Text('Hili husi Galeria'),
                onTap: () {
                  Navigator.pop(context);
              ...
              ListTile(
                ...
                title: const Text('Hasai Foto sira'),
                onTap: () {
                  Navigator.pop(context);
              ...
              if (_currentProfileImage != null || _newProfileImage != null)
                ListTile(
                  ...
                  title: const Text('Apaga Foto sira',
  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      print('Erru hili imajen: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('La konsege hili imajen'),
  ...
  void _removeProfileImage() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Apaga Foto Perfil'),
          content: const Text(
              'Ita-boot iha serteza katak ita-boot hakarak atu hamoos ita-boot nia foto perfil?'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
            ...
            TextButton(
              ...
              child: const Text('Hamoos', style: TextStyle(color: Colors.red)),
            ),
          ],
        );
      },
  ...
  Future<String?> _imageToBase64(File image) async {
    try {
      ...
      print('Erru konverte imajen ba base64: $e');
      return null;
    }
  }
    ...
    try {
      ...
      if (user != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Perfil atualiza ho susesu'),
      ...
      print('Erru iha salvasaun perfil: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('La konsege atualiza perfil'),
            backgroundColor: Colors.red,
          ),
        );
      }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        label: 'Naran Uzuáriu',
                        hint: 'Hatama ita-boot nia naran utilizadór',
                      ...
                      _buildTextField(
                        ...
                        hint: 'Hatama númeru telefone ida',
