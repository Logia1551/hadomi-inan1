      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            _buildInfoItem('Naran kompletu', _name ?? 'Naran la disponivel'),
            _buildInfoItem('Númeru telefone', _phone ?? 'Númeru la disponivel'),
            _buildInfoItem('Enderessu', _address ?? 'Enderesu la disponivel'),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildSettingItem(
              'Edita Perfil',
              'Atualiza ita-boot nia informasaun perfil',
              Icons.person_outline,
              Colors.green,
              onTap: () async {
            ...
            _buildSettingItem(
              'Troka Senha',
              'Troka Ita-boot nia senha konta nian',
              Icons.lock_outline,
              Colors.green,
              onTap: () {
                Navigator.push(
        ...
        child: Column(
          children: [
            ...
            _buildSettingItem(
              ...
              'Konfigura ita-boot nia vizibilidade dadus nian',
