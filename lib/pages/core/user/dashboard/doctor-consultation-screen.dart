...
class DoctorConsultationScreen extends StatelessWidget {
  ...
  Widget _buildDoctorCard({
    ...
    String? profileImage, // Tambah parameter profileImage
  }) {
    return Card(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            '${experience} tinan', // Tambahkan 'tahun' di sini
                            style: TextStyle(
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
              ...
              child: ElevatedButton(
                onPressed: available
                    ? () => _startConsultation(context, {
                          ...
                          'profileImage':
                              profileImage, // Tambahkan profileImage
                        })
                    : null,
                ...
                child: Text(
                  available ? 'Hahú Konsulta' : 'La disponivel',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (doctors.isEmpty) {
            return const Center(
              child: Text(
                  'Laiha doutór/parteira sira ne ebé disponivel iha tempu ida-ne e'),
            );
          }
              ...
              children: [
                ...
                ...doctors.map((doc) {
                  ...
                  return _buildDoctorCard(
                    ...
                    specialty: data['specialty'] ?? 'Jerál',
                    experience: (data['experience'] ?? 0)
                        .toString(), // Converted to string with 'tahun'
                    available: data['isAvailable'] ?? false,
                    description: data['description'] ?? '',
                    profileImage: data['profileImage'], // Tambahkan ini
                  );
                }).toList(),
              ],
            ),
